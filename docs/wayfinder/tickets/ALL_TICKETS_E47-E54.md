...
1. **Teacher Pathway (Training-Only)**: For each ground-truth traffic light with area $<256\text{ px}^2$ (side $<16\text{ px}$), a local crop is dynamically extracted with $15\%$ context margin and bilinearly upsampled to $64\times64\text{ px}$.
...
===== FILE: E53-scale-conditioned-calibration.md =====
---
...
===== FILE: E54-atlas-lisa-domain-generalization-audit.md =====
---
